...
import com.example.hellen.smartmarket.parser.NdefMessageParser;
...
public class SmartPoster implements ParsedNdefRecord {
     ...
     * optional."
     */
    private final com.example.hellen.smartmarket.record.TextRecord mTitleRecord;
     ...
     */
    private final com.example.hellen.smartmarket.record.UriRecord mUriRecord;
   ...
   /* public View getView(Activity activity, LayoutInflater inflater, ViewGroup parent, int offset) {
        if (mTitleRecord != null) {
            ...
            inflater.inflate(R.layout.activity_nfc, container);
